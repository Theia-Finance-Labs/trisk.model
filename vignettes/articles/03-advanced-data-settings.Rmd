...
`trisk.model`. Note that this may require installing additional
...
described in the vignette [Set up project directories](https://2degreesinvesting.github.io/trisk.model/articles/articles/01-setup-project-directories.html).
...
directories](https://2degreesinvesting.github.io/trisk.model/articles/articles/01-setup-project-directories.html).
...
inputs](https://2degreesinvesting.github.io/trisk.model/articles/articles/02-prepare-loans-inputs.html).
...
You can now run the stress test as described in vignette [Run stress test](https://2degreesinvesting.github.io/trisk.model/articles/articles/02-run-stress-test.html).
