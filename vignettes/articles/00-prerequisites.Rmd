...
This vignette describes the necessary prerequisites for installing `trisk.model` and performing the stress testing analysis.
...
* [README document with installation procedure](https://2degreesinvesting.github.io/trisk.model/index.html)
* [Set up project directories for climate transition risk stress test](https://2degreesinvesting.github.io/trisk.model/articles/articles/01-setup-project-directories.html)

### Is the 1in1000 model suite ran for you by 2DII ? 
*  [Read and understand the output of the  1in1000 model suite  ](https://2degreesinvesting.github.io/trisk.model/articles/articles/04-setup-project-directories.html)
