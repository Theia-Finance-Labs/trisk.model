...
The trisk.model currently supports a number of scenario geographies 
...
settings"](https://2degreesinvesting.github.io/trisk.model/articles/articles/04-advanced-data-settings.html).
...
[Understand the output files of the transition risk stress test](https://2degreesinvesting.github.io/trisk.model/articles/articles/04-read-the-outputs.html).
