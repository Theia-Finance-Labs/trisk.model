...
scenarios_csv <- readr::read_csv(fs::path(INPUT_DIR, "scenarios.csv"))
ngfs_carbon_price_csv <- readr::read_csv(fs::path(INPUT_DIR, "ngfs_carbon_price.csv"))
...
trisk_results <- run_trisk_model(
    assets_data=assets_data,
                            scenarios_data=scenarios_csv,
                            financial_data=financial_data,
                            carbon_data=ngfs_carbon_price_csv,
